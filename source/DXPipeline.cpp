...
DXPipeline::DXPipeline(uint32_t viewportWidth, uint32_t viewportHeight, std::wstring name) :
...
void DXPipeline::GetHardwareAdapter(IDXGIFactory2* pFactory, IDXGIAdapter1** ppAdapter)
{
...
_Use_decl_annotations_
void DXPipeline::ParseCommandLineArgs(WCHAR* argv[], int argc)
{
